...
class ObjectiveController extends Controller {
    ...
    /**
     * Populate graph for objectives by month
     *
     * @return void
     */
    public function populateObjectiveGraph()
    {
          $objective = $this->viewData['objective'];
          $graph = [];  
          ...
          $sql = "select
                ...
                from
                    ...
                    inner join objectives o ON i.objective_id = o.id and o.id = ".$objective->id."
          ...
          $graph['title'] = "BSC Report: ".$objective->name;
